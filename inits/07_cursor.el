;;; 07_cursor.el --- Cursor Utility configurations. -*- lexical-binding: t; no-byte-compile: t -*-
;;; Commentary:
;;; Code:
...
(leaf point-history
  ...
  :init
  (setq point-history-ignore-buffer "^ \\*Minibuf\\|^*\\|^ \\*point-history-show*\\|^magit\\|\]$")
  (setq point-history-ignore-major-mode '(magit-mode ruby-mode)))
