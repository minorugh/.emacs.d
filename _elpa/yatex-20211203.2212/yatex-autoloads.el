...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "yatex" '("LaTeX2e-fontstyle-alist" "NTT-jTeX" "YaTeX-" "bibtex-command" "dvi" "env-table" "fontsize-table" "latex-" "makeindex-command" "section-table" "singlecmd-table" "tex-" "tmp-" "user-" "yatex-mode")))
...
Show which kind of column the current position is belonging to." t nil)
...
Indent a line in equation family." nil nil)
...
Return the kanji-mnemonic of pTeX from current buffer's coding-system." nil nil)
...
Use this function after editing ./.yatexrc." t nil)
...
(autoload 'point-beginning-of-line "yatexlib" nil nil nil)

(autoload 'point-end-of-line "yatexlib" nil nil nil)
...
(autoload 'YaTeX-window-list "yatexlib" nil nil nil)
...
in t, exit minibuffer immediately." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "yatexlib" '("YaTeX-" "bcf-and-exit" "foreach-buffers" "goto-buffer-window" "latex-message-kanji-code" "tfb-and-exit")))
...
Go to corresponding mathematical parentheses." nil nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "yatexpkg" '("YaTeX")))
...
Input sectining command with previous overview." t nil)
