...
#+END_EXAMPLE
   ...
   - [[*eary-init][eary-init]] :: 早期設定ファイルの設定
...
*** eary-init
   :PROPERTIES:
   :EXPORT_FILE_NAME: eary-init
   :END:

*** 早期初期化ファイル
🔗 [[https://github.com/minorugh/.emacs.d/blob/main/early-init.el][minorugh/.emacs.d/early-init.el]]
